    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-6 sm:p-7 lg:p-8 shadow-sm">
      <div className="mb-6 space-y-3 text-center sm:text-left">
        ...
        <Link
          ...
          className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-purple-200 bg-purple-50/60 px-4 py-2 text-xs sm:w-auto sm:text-sm font-medium text-purple-600 transition-colors hover:border-purple-300 hover:bg-purple-100 hover:text-purple-700"
        >
      ...
      {!isConnected && (
        <div className="flex flex-col items-center">
          <button
            onClick={onConnect}
            className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-purple-500 to-pink-500 px-6 py-3 text-base font-semibold text-white shadow-lg transition-all hover:shadow-xl hover:from-purple-600 hover:to-pink-600 active:scale-95"
          >
