    ...
    <div ref={containerRef} className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <motion.div className="absolute inset-0 z-0" style={{ y, opacity }}>
          ...
          >
            <source src={videoPinCapAI} type="video/mp4" />
          </video>
        ...
        >
          ...
          <motion.h1
            variants={fadeInUp}
            className="w-[1000px] text-3xl md:text-4xl lg:text-6xl font-bold mb-6 text-balance"
          >
          ...
          <motion.div variants={fadeInUp}>
            <button
              ...
              className="!bg-rose-600 hover:!bg-rose-700 !text-white !px-8 !py-4 !text-lg !rounded-full !transition-all !duration-300 hover:!scale-105 hover:!shadow-lg !inline-flex !items-center !cursor-pointer"
            >
              Khám phá ngay
          ...
          >
            ...
            >
              ...
              <p className="text-lg text-gray-600 text-pretty leading-relaxed">
                Khám phá và khơi nguồn cảm hứng từ thế giới xung quanh thông qua
                việc tìm kiếm ý tưởng từ những hình ảnh tuyệt vời.
              </p>
          ...
          >
            <motion.div variants={fadeInUp} className="!space-y-6">
              ...
              <p className="text-lg text-white/90 text-pretty leading-relaxed">
                Khám phá nguồn cảm hứng không giới hạn từ các video đa dạng trên
                mạng, để tạo ra những ý tưởng mới và sáng tạo.
              </p>
        ...
        <div className="container flex flex-col items-center justify-center gap-20 mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto text-pretty">
              Trải nghiệm sức mạnh của trí tuệ nhân tạo trong việc chỉnh sửa và
              tạo nội dung
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Tự động cải thiện chất lượng hình ảnh và video với công nghệ AI tiên tiến",
              },
              {
                icon: ImageIcon,
                title: "Tìm kiếm trực quan",
                description:
                  "Khám phá nội dung thông qua tìm kiếm bằng hình ảnh và nhận diện thông minh",
              },
              {
                icon: Zap,
                title: "Xử lý nhanh chóng",
                description:
                  "Tốc độ xử lý siêu nhanh giúp bạn tiết kiệm thời gian và nâng cao hiệu suất",
              },
            ].map((feature, index) => (
      ...
      <section className="py-20 bg-rose-600 text-white">
        <div className="container mx-auto !px-4 text-center">
          ...
          >
            ...
            >
              Tham gia cùng hàng triệu người dùng đang tìm kiếm cảm hứng mỗi
              ngày
            </motion.p>
            <motion.div variants={fadeInUp}>
